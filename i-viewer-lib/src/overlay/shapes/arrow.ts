...
export default class Arrow extends BaseShape {
  ...
  _createShape(point: OverlayManagerTypes.Point, attrs?: OverlayManagerTypes.ShapeAttr) {
    const shape = new Konva.Arrow({
      ...
      pointerLength: (this._shapeOptions.strokeWidth * ArrowMultipleStrokeWidth) / this._stage.scaleX(),
      pointerWidth: (this._shapeOptions.strokeWidth * ArrowMultipleStrokeWidth) / this._stage.scaleX(),
