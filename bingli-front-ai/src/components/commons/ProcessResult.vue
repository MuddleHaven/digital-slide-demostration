...
import { getCheckoutOptionLabel, SlicePart } from '../../utils/options';
import { colonConditionKeys } from '../../utils/options-colon'
import { lungConditionKeys } from '../../utils/options-lung'
import { stomachConditionKeys } from '../../utils/options-stomach'
