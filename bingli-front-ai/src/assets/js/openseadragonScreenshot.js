...
export default function extendOpenSeadragonWithScreenshot(OpenSeadragon) {
  'use strict';
  ...
  OpenSeadragon.Viewer.prototype.screenshot = function (options) {
    if (!this.screenshotInstance || options) {
      options = options || {};
      options.viewer = this;
      this.screenshotInstance = new OpenSeadragon.Screenshot(options);
    }
   ...
   */
  OpenSeadragon.Screenshot = function (options) {
    ...
    this.outerTracker = new OpenSeadragon.MouseTracker({
      ...
      clickTimeThreshold: this.viewer.clickTimeThreshold,
      clickDistThreshold: this.viewer.clickDistThreshold,
      clickHandler: OpenSeadragon.delegate(this, onOutsideClick),
  ...
  OpenSeadragon.extend(OpenSeadragon.Screenshot.prototype, OpenSeadragon.ControlDock.prototype, /** @lends OpenSeadragon.ControlDock.prototype */ {
    ...
    takeScreenshot: function () {
      ...
      var downloadFunction = function () {
        ...
        Canvas.toBlob(function (blob) {
          ...
          // 构造文件名
          var fileName = "screenshot_" + formattedDate + ".png";
    ...
    menuUpdate: function () {
      ...
      document.getElementById('screenshotTextMessage').innerHTML = "下载尺寸: " + Math.round(this.screenshotWidth) + "x" + Math.round(this.screenshotHeight);
    }
  });
